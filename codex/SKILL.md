...
3. `/codex` with no arguments — **Auto-detect:**
   ...
   - If a diff exists, auto-decide: run **Review mode** (code review with pass/fail gate) as the default action. Log: `[AUTO-DECISION] Diff detected against base branch — running code review mode.`
...
If a session file exists (not `NO_SESSION`), auto-decide: continue the existing conversation for context continuity. Log: `[AUTO-DECISION] Existing Codex session found — continuing previous conversation.`
